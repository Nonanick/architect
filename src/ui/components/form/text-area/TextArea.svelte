<script lang="ts">
  import editor, { OutputData, LogLevels } from "@editorjs/editorjs";
...
<div class="textarea-container {$$props.class}">
  ...
  <div class="input-container {errors.length > 0 ? 'contain-errors' : ''}">
    <div class="textarea-input" bind:this={editorViewport} {name} />
  </div>
